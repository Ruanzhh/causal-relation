...
class Predict_Network(nn.Module):
    ...
    def get_opp_intrinsic(self, s_a, s, a, enemies_visible, avail_u=None):
        # print(f"s_a: {s_a.shape}, s: {s.shape}, a: {a.shape}")
