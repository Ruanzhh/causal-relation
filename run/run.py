...
def run_sequential(args, logger):
    ...
    args.extrin_env_size=env_info['extrin_env_size']
    args.ally_size=env_info['ally_size']
    ...
    scheme = {
        ...
        "extrinsic_state": {"vshape": env_info['extra_inf_size']},
        "visible_matrix": {"vshape": (env_info["n_enemies"]+env_info["n_agents"],), "group": "agents"},
    ...
    while runner.t_env <= args.t_max:
        ...
        if args.save_model and (runner.t_env - model_save_time >= args.save_model_interval or model_save_time == 0):
            ...
            save_path = os.path.join(args.local_results_path, "models",args.env_args['map_name'], args.label, str(runner.t_env))
